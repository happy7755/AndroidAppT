...
// https://gist.github.com/slightfoot/6330866
    ...
    static public Note getNote() {
        ...
        if (currentOcarina.equals("4Hole")) {
            if (Arrays.equals(buttons, new boolean[] {true, true, true, true, false, false, false, false, false, false, false, false}) && OcarinaActivity.sound_use) {
                return Note.C_5;
            }

            if (Arrays.equals(buttons, new boolean[] {false, true, true, true, false, false, false, false, false, false, false, false}) && OcarinaActivity.sound_use) {
                return Note.D_5;
            }

            if (Arrays.equals(buttons, new boolean[] {true, false, true, true, false, false, false, false, false, false, false, false}) && OcarinaActivity.sound_use) {
                return Note.E_5;
            }

            if (Arrays.equals(buttons, new boolean[] {false, false, true, true, false, false, false, false, false, false, false, false}) && OcarinaActivity.sound_use) {
                return Note.F_5;
            }

            if (Arrays.equals(buttons, new boolean[] {true, true, false, true, false, false, false, false, false, false, false, false}) && OcarinaActivity.sound_use) {
                return Note.F_5_SHARP;
            }

            if (Arrays.equals(buttons, new boolean[] {false, true, false, true, false, false, false, false, false, false, false, false}) && OcarinaActivity.sound_use) {
                return Note.G_5;
            }

            if (Arrays.equals(buttons, new boolean[] {true, false, false, true, false, false, false, false, false, false, false, false}) && OcarinaActivity.sound_use) {
                return Note.G_5_SHARP;
            }

            if (Arrays.equals(buttons, new boolean[] {false, false, false, true, false, false, false, false, false, false, false, false}) && OcarinaActivity.sound_use) {
                return Note.A_5;
            }

            if (Arrays.equals(buttons, new boolean[] {false, true, false, false, false, false, false, false, false, false, false, false}) && OcarinaActivity.sound_use) {
                return Note.A_5_SHARP;
            }

            if (Arrays.equals(buttons, new boolean[] {true, false, false, false, false, false, false, false, false, false, false, false}) && OcarinaActivity.sound_use) {
                return Note.B_5;
            }

            if (Arrays.equals(buttons, new boolean[] {false, false, false, false, false, false, false, false, false, false, false, false}) && OcarinaActivity.sound_use) {
